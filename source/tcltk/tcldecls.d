...
extern(C) const(char)* Tcl_Concat(int argc, const(char)** argv) nothrow;
extern(C) int Tcl_ConvertElement(const(char)* src, const(char)* dst, int flags) nothrow;
...
extern(C) const(char)* Tcl_DStringAppend(Tcl_DString* dsPtr, const(char)* bytes, int length) nothrow;
extern(C) const(char)* Tcl_DStringAppendElement(Tcl_DString* dsPtr, const(char)* element) nothrow;
...
extern(C) const(char)* Tcl_ErrnoId() nothrow;
extern(C) const(char)* Tcl_ErrnoMsg(int err) nothrow;
...
extern(C) const(char)* Tcl_GetHostName() nothrow;
...
extern(C) const(char)* Tcl_GetNameOfExecutable() nothrow;
...
extern(C) const(char)* Tcl_GetStringResult(Tcl_Interp* interp) nothrow;
extern(C) const(char)* Tcl_GetVar(Tcl_Interp* interp, const(char)* varName, int flags) nothrow;
extern(C) const(char)* Tcl_GetVar2(Tcl_Interp* interp, const(char)* part1, const(char)* part2, int flags) nothrow;
...
extern(C) const(char)* Tcl_JoinPath(int argc, const(char)** argv, Tcl_DString* resultPtr) nothrow;
extern(C) int Tcl_LinkVar(Tcl_Interp* interp, const(char)* varName, const(char)* addr, int type) nothrow;
...
extern(C) const(char)* Tcl_Merge(int argc, const(char)** argv) nothrow;
...
extern(C) void Tcl_PrintDouble(Tcl_Interp* interp, double value, const(char)* dst) nothrow;
extern(C) int Tcl_PutEnv(const(char)* assignment) nothrow;
extern(C) const(char)* Tcl_PosixError(Tcl_Interp* interp) nothrow;
extern(C) void Tcl_QueueEvent(Tcl_Event* evPtr, Tcl_QueuePosition position) nothrow;
extern(C) int Tcl_Read(Tcl_Channel chan, const(char)* bufPtr, int toRead) nothrow;
...
extern(C) const(char)* Tcl_SetVar(Tcl_Interp* interp, const(char)* varName, const(char)* newValue, int flags) nothrow;
extern(C) const(char)* Tcl_SetVar2(Tcl_Interp* interp, const(char)* part1, const(char)* part2, const(char)* newValue, int flags) nothrow;
extern(C) const(char)* Tcl_SignalId(int sig) nothrow;
extern(C) const(char)* Tcl_SignalMsg(int sig) nothrow;
...
extern(C) const(char)* Tcl_TranslateFileName(Tcl_Interp* interp, const(char)* name, Tcl_DString* bufferPtr) nothrow;
...
extern(C) const(char)* Tcl_HashStats(Tcl_HashTable* tablePtr) nothrow;
extern(C) const(char)* Tcl_ParseVar(Tcl_Interp* interp, const(char)* start, const(char)** termPtr) nothrow;
extern(C) const(char)* Tcl_PkgPresent(Tcl_Interp* interp, const(char)* name, const(char)* version_, int exact) nothrow;
extern(C) const(char)* Tcl_PkgPresentEx(Tcl_Interp* interp, const(char)* name, const(char)* version_, int exact, ClientData* clientDataPtr) nothrow;
extern(C) int Tcl_PkgProvide(Tcl_Interp* interp, const(char)* name, const(char)* version_) nothrow;
extern(C) const(char)* Tcl_PkgRequire(Tcl_Interp* interp, const(char)* name, const(char)* version_, int exact) nothrow;
...
extern(C) int Tcl_ExternalToUtf(Tcl_Interp* interp, Tcl_Encoding encoding, const(char)* src, int srcLen, int flags, Tcl_EncodingState* statePtr, const(char)* dst, int dstLen, int* srcReadPtr, int* dstWrotePtr, int* dstCharsPtr) nothrow;
extern(C) const(char)* Tcl_ExternalToUtfDString(Tcl_Encoding encoding, const(char)* src, int srcLen, Tcl_DString* dsPtr) nothrow;
...
extern(C) const(char)* Tcl_GetEncodingName(Tcl_Encoding encoding) nothrow;
...
extern(C) int Tcl_UniCharToUtf(int ch, const(char)* buf) nothrow;
extern(C) const(char)* Tcl_UtfAtIndex(const(char)* src, int index) nothrow;
extern(C) int Tcl_UtfCharComplete(const(char)* src, int length) nothrow;
extern(C) int Tcl_UtfBackslash(const(char)* src, int* readPtr, const(char)* dst) nothrow;
extern(C) const(char)* Tcl_UtfFindFirst(const(char)* src, int ch) nothrow;
extern(C) const(char)* Tcl_UtfFindLast(const(char)* src, int ch) nothrow;
extern(C) const(char)* Tcl_UtfNext(const(char)* src) nothrow;
extern(C) const(char)* Tcl_UtfPrev(const(char)* src, const(char)* start) nothrow;
extern(C) int Tcl_UtfToExternal(Tcl_Interp* interp, Tcl_Encoding encoding, const(char)* src, int srcLen, int flags, Tcl_EncodingState* statePtr, const(char)* dst, int dstLen, int* srcReadPtr, int* dstWrotePtr, int* dstCharsPtr) nothrow;
extern(C) const(char)* Tcl_UtfToExternalDString(Tcl_Encoding encoding, const(char)* src, int srcLen, Tcl_DString* dsPtr) nothrow;
extern(C) int Tcl_UtfToLower(const(char)* src) nothrow;
extern(C) int Tcl_UtfToTitle(const(char)* src) nothrow;
extern(C) int Tcl_UtfToUniChar(const(char)* src, Tcl_UniChar* chPtr) nothrow;
extern(C) int Tcl_UtfToUpper(const(char)* src) nothrow;
...
extern(C) const(char)* Tcl_GetString(Tcl_Obj* objPtr) nothrow;
extern(C) const(char)* Tcl_GetDefaultEncodingDir() nothrow;
...
extern(C) const(char)* Tcl_UniCharToUtfDString(const(Tcl_UniChar)* uniStr, int uniLength, Tcl_DString* dsPtr) nothrow;
...
extern(C) const(char)* Tcl_GetCwd(Tcl_Interp* interp, Tcl_DString* cwdPtr) nothrow;
...
extern(C) int Tcl_ReadRaw(Tcl_Channel chan, const(char)* dst, int bytesToRead) nothrow;
...
extern(C) const(char)* Tcl_ChannelName(const(Tcl_ChannelType)* chanTypePtr) nothrow;
...
extern(C) const(char)** Tcl_FSFileAttrStrings(Tcl_Obj* pathPtr, Tcl_Obj** objPtrRef) nothrow;
...
extern(C) int Tcl_DictObjPutKeyList(Tcl_Interp* interp, Tcl_Obj* dictPtr, int keyc, const(Tcl_Obj*)* keyv, Tcl_Obj* valuePtr) nothrow;
...
extern(C) const(char)* Tcl_GetEncodingNameFromEnvironment(Tcl_DString* bufPtr) nothrow;
...
struct TclStubs
{
	...
	extern(C) const(char)* function(int argc, const(char)** argv) nothrow tcl_Concat;
	extern(C) int function(const(char)* src, const(char)* dst, int flags) nothrow tcl_ConvertElement;
	...
	extern(C) const(char)* function(Tcl_DString* dsPtr, const(char)* bytes, int length) nothrow tcl_DStringAppend;
	extern(C) const(char)* function(Tcl_DString* dsPtr, const(char)* element) nothrow tcl_DStringAppendElement;
	...
	extern(C) const(char)* function() nothrow tcl_ErrnoId;
	extern(C) const(char)* function(int err) nothrow tcl_ErrnoMsg;
	...
	extern(C) const(char)* function() nothrow tcl_GetHostName;
	...
	extern(C) const(char)* function() nothrow tcl_GetNameOfExecutable;
	...
	extern(C) const(char)* function(Tcl_Interp* interp) nothrow tcl_GetStringResult;
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* varName, int flags) nothrow tcl_GetVar;
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* part1, const(char)* part2, int flags) nothrow tcl_GetVar2;
	...
	extern(C) const(char)* function(int argc, const(char)** argv) nothrow tcl_Merge;
	...
	extern(C) void function(Tcl_Interp* interp, double value, const(char)* dst) nothrow tcl_PrintDouble;
	extern(C) int function(const(char)* assignment) nothrow tcl_PutEnv;
	extern(C) const(char)* function(Tcl_Interp* interp) nothrow tcl_PosixError;
	extern(C) void function(Tcl_Event* evPtr, Tcl_QueuePosition position) nothrow tcl_QueueEvent;
	extern(C) int function(Tcl_Channel chan, const(char)* bufPtr, int toRead) nothrow tcl_Read;
	...
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* varName, const(char)* newValue, int flags) nothrow tcl_SetVar;
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* part1, const(char)* part2, const(char)* newValue, int flags) nothrow tcl_SetVar2;
	extern(C) const(char)* function(int sig) nothrow tcl_SignalId;
	extern(C) const(char)* function(int sig) nothrow tcl_SignalMsg;
	...
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* name, Tcl_DString* bufferPtr) nothrow tcl_TranslateFileName;
	...
	extern(C) const(char)* function(Tcl_HashTable* tablePtr) nothrow tcl_HashStats;
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* start, const(char)** termPtr) nothrow tcl_ParseVar;
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* name, const(char)* version_, int exact) nothrow tcl_PkgPresent;
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* name, const(char)* version_, int exact, ClientData* clientDataPtr) nothrow tcl_PkgPresentEx;
	extern(C) int function(Tcl_Interp* interp, const(char)* name, const(char)* version_) nothrow tcl_PkgProvide;
	extern(C) const(char)* function(Tcl_Interp* interp, const(char)* name, const(char)* version_, int exact) nothrow tcl_PkgRequire;
	...
	extern(C) int function(Tcl_Interp* interp, Tcl_Encoding encoding, const(char)* src, int srcLen, int flags, Tcl_EncodingState* statePtr, const(char)* dst, int dstLen, int* srcReadPtr, int* dstWrotePtr, int* dstCharsPtr) nothrow tcl_ExternalToUtf;
	extern(C) const(char)* function(Tcl_Encoding encoding, const(char)* src, int srcLen, Tcl_DString* dsPtr) nothrow tcl_ExternalToUtfDString;
	...
	extern(C) const(char)* function(Tcl_Encoding encoding) nothrow tcl_GetEncodingName;
	...
	extern(C) int function(int ch, const(char)* buf) nothrow tcl_UniCharToUtf;
	extern(C) const(char)* function(const(char)* src, int index) nothrow tcl_UtfAtIndex;
	extern(C) int function(const(char)* src, int length) nothrow tcl_UtfCharComplete;
	extern(C) int function(const(char)* src, int* readPtr, const(char)* dst) nothrow tcl_UtfBackslash;
	extern(C) const(char)* function(const(char)* src, int ch) nothrow tcl_UtfFindFirst;
	extern(C) const(char)* function(const(char)* src, int ch) nothrow tcl_UtfFindLast;
	extern(C) const(char)* function(const(char)* src) nothrow tcl_UtfNext;
	extern(C) const(char)* function(const(char)* src, const(char)* start) nothrow tcl_UtfPrev;
	extern(C) int function(Tcl_Interp* interp, Tcl_Encoding encoding, const(char)* src, int srcLen, int flags, Tcl_EncodingState* statePtr, const(char)* dst, int dstLen, int* srcReadPtr, int* dstWrotePtr, int* dstCharsPtr) nothrow tcl_UtfToExternal;
	extern(C) const(char)* function(Tcl_Encoding encoding, const(char)* src, int srcLen, Tcl_DString* dsPtr) nothrow tcl_UtfToExternalDString;
	extern(C) int function(const(char)* src) nothrow tcl_UtfToLower;
	extern(C) int function(const(char)* src) nothrow tcl_UtfToTitle;
	extern(C) int function(const(char)* src, Tcl_UniChar* chPtr) nothrow tcl_UtfToUniChar;
	extern(C) int function(const(char)* src) nothrow tcl_UtfToUpper;
	...
	extern(C) const(char)* function(Tcl_Obj* objPtr) nothrow tcl_GetString;
	extern(C) const(char)* function() nothrow tcl_GetDefaultEncodingDir;
	...
	extern(C) const(char)* function(const(Tcl_UniChar)* uniStr, int uniLength, Tcl_DString* dsPtr) nothrow tcl_UniCharToUtfDString;
	...
	extern(C) const(char)* function(Tcl_Interp* interp, Tcl_DString* cwdPtr) nothrow tcl_GetCwd;
	...
	extern(C) int function(Tcl_Channel chan, const(char)* dst, int bytesToRead) nothrow tcl_ReadRaw;
	...
	extern(C) const(char)* function(const(Tcl_ChannelType)* chanTypePtr) nothrow tcl_ChannelName;
	...
	extern(C) const(char)** function(Tcl_Obj* pathPtr, Tcl_Obj** objPtrRef) nothrow tcl_FSFileAttrStrings;
	...
	extern(C) int function(Tcl_Interp* interp, Tcl_Obj* dictPtr, int keyc, const(Tcl_Obj*)* keyv) nothrow tcl_DictObjRemoveKeyList;
	...
	extern(C) const(char)* function(Tcl_DString* bufPtr) nothrow tcl_GetEncodingNameFromEnvironment;
